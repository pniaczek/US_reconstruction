...
def generate_slic(input_folder, output_folder):
...
def main():
    parser = argparse.ArgumentParser(description="Generate slic segmentation in a folder.")
    ...
    generate_slic(args.input_folder, args.output_folder)
